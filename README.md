# SerialAT
Small command line utility that allows you to send SMS messages vis AT commands (Hayes cmd set) through a GSM module that supports serial communication over USB in Windows.
